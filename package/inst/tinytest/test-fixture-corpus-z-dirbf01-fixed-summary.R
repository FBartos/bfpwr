...
## Gated fixture-corpus test for fixed-sample directional z BF simulations. There
## is no direct bfssd/BFGSD manuscript derivation for dirbf01; these are
## package-only MC fixture checks.
...
representative_cases <- data.frame(
    bf_prior_id = c(
        ...
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dpoint-0p5-usd1-short",
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dnorm-0p2-s0p5-usd1-short",
        ...
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dnorm-0-s0p5-usd1-short",
        "z-dirbf01-directional-normal-null0-pm0-psd20-on-z-dpoint-10-usd50-short",
        "z-dirbf01-directional-normal-null0-pm0-psd20-on-z-dnorm-10-s20-usd50-short",
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dpoint-0-usd1-long",
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dpoint-0p2-usd1-long",
        "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dnorm-0p2-s0p5-usd1-long",
        "z-dirbf01-directional-normal-null0p2-pm0p2-psd0p70710678-on-z-dnorm-0p2-s0p5-usd1-long"
    ),
    design_role = c(
        "null", "alternative", "alternative", "alternative", "alternative",
        "adversarial", "adversarial", "adversarial", "adversarial",
        "null", "alternative", "alternative", "alternative"
    ),
    prior_form = c(
        "directional-normal", "directional-normal", "directional-normal",
        "directional-normal", "shifted-directional-normal",
        "directional-normal", "directional-normal",
        "extreme-directional-normal", "extreme-directional-normal",
        "directional-normal", "directional-normal",
        "directional-normal", "shifted-directional-normal"
    ),
    look_grid_name = c(
...
for (i in seq_len(nrow(check_rows))) {
    ...
    reference <- bfpwr_sim_z_directional_reference(
        k1 = 1 / row$evidence_threshold,
        k0 = row$evidence_threshold,
        n = row$n,
    ...
    expect_true(
        ...
        info = paste("fixed-summary probability agrees with pbf01seq directional reference:",
...
bfpwr_fixture_expect_fixed_search_first_crossing(
    fixture,
    bf_prior_id = "z-dirbf01-directional-normal-null0-pm0-psd0p70710678-on-z-dpoint-0p2-usd1-short",
    tail = "H1",
