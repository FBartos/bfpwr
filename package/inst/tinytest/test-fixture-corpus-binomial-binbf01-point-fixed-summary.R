...
## Gated fixture-corpus test for fixed-sample binomial point-null BF simulations.
## No bfssd manuscript formula covers binomial BF power; binary outcomes are
## future work in paper/bfssd.Rnw 1854-1856, so this is package-only coverage.
...
required_fixture_dir <- file.path("fixtures", "binomial", "fixed",
                                  "binom-binbf01-point-fixed-core-v1")
...
representative_cases <- data.frame(
    bf_prior_id = c(
        ...
        "binom-binbf01-point-p00p5-a1-b1-on-binom-dpoint-0p2-short",
        "binom-binbf01-point-p00p75-a1-b1-on-binom-dpoint-0p75-short",
        "binom-binbf01-point-p00p6-a1-b1-on-binom-dbeta-60-40-short",
        "binom-binbf01-point-p00p5-a60-b40-on-binom-dbeta-1-1-h1gt0p5-short",
        ...
        "binom-binbf01-point-p00p55-a1-b1-on-binom-dpoint-0p55-long",
        "binom-binbf01-point-p00p5-a5100-b4900-on-binom-dpoint-0p55-long"
    ),
    design_role = c(
        "null", "alternative", "adversarial", "null", "alternative",
        "adversarial", "adversarial", "null", "alternative",
        "adversarial"
    ),
    prior_form = c(
        "default", "default", "default", "matched-null", "matched-null",
        "concentrated-h1", "concentrated-h0", "default", "matched-null",
        "large-shape"
    ),
    look_grid_name = c(
...
expect_true(all(c("default", "matched-null", "concentrated-h1",
                  "concentrated-h0", "large-shape") %in%
                    representative_cases$prior_form),
            info = "stratified checks include default, matched, concentrated, and large-shape priors")
...
bfpwr_fixture_expect_fixed_search_first_crossing(
    fixture,
    bf_prior_id = "binom-binbf01-point-p00p5-a1-b1-on-binom-dpoint-0p6-short",
    tail = "H1",
    evidence_threshold = 10,
    target_prob = 0.8,
    label = "fixed binomial point fixture")
